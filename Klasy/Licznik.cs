  ...
  public class Licznik
  {
    ...
    public void Saver()
    {
      foreach (var i in tablica)
      {
        ...
        File.AppendAllText(filePathButToSearch[filePathButToSearch.Length -1], i + "\n");
      }
    ...
    public int podlicza1i3i5linie()
    {
      ...
      for (int i = 0; i < dlugoscFora; i = i += 2)
      {
        string[] tablicaZPliku = File.ReadAllLines(filePath[filePath.Length - 1]);
